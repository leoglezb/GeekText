	...
	<div class="container-fluid max-1200">
		...
		<div class="row-fluid">
			...
			<div class="small-header">
				<div class="logo-z">
					<img src="resources/img/logo-z.png">
				</div>
				<div class="display-pic">
					<img class="img-circle" src="resources/profiles/${userdetails.username}-profile.jpg" alt=""> 
				</div>
				<ul class="nav pull-left">
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown">
							<h4>
								Hello ${userdetails.name} &nbsp;<i class="icon-caret-down">
								</i>
							</h4>
					</a>
		...
		<div class="row-fluid">
			<div class="span8 pull-left">
			    <h2>Based on your interest in miami area we found:</h2>
			      ...
			      <!-- /dynamic-info -->   
      			<h2>We found the below recommended business near your area:</h2>
				<hr>
				<p>Found total of 14 issues within 2 mile radius. Use the slider
					to modify the distance.</p>
				...
				<div id="pagination" class="pagination">
				    ...
				    <a id="urlnext" href="businesspag"/></a>
			...
			<div class="span4 pull-right">
				<div class="well">
					<h2>Recommend a Business</h2>
					<hr>
					<form method="post" action="addBusiness" enctype="multipart/form-data">

						<fieldset>
							<label>Business name</label> 
							<input class="span10" type="text" placeholder="Event name" id="title" name="title"> 
							...
							<p>
								Enter tag's to easily find the business <br>ex:Insurance,
								Car Sales
							...
							<br> <label class="checkbox"> <input type="checkbox">
								I agree to <a href="#">Terms &amp; Condition</a><br> <input
								type="checkbox"> Post as anonymous
							</label>
				...
				<h2>Business Recommended by you</h2>
				<hr>
				<div class="thumb-list">
					...
					<a class="btn-mini pull-left" href="editrecommendations">Edit Recommendations </a> <a
						class="btn-mini pull-right">View More </a>
				</div>
