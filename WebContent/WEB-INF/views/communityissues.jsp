...
<head>
<meta charset="utf-8">
<title>Zoowaa Community Issues</title>
...
<div class="container-fluid max-1200"> 
  ...
  <div class="row-fluid">
    <div class="span8 pull-left"> 
	    <h2>Based on your interest in miami area we found:</h2>
	      ...
	      <!-- /dynamic-info -->  
	      <h2>We  found the below issues near your area:</h2>
	      <hr>
	      <p>Found total of 14 issues within 2 mile radius. Use the slider to modify the distance.</p>
	      
	      <input class="span3" type="text" data-slider="true">
	    <form>
	            <p>Click the tag's below to see related result.</p>
	            <ul id="readOnlyTags">
	                <li>Childerns Party</li>
	                <li>Garage Sales</li>
	            </ul>
	        </form>
	      <!-- /dynamic-Tags -->
		...
		<div id="pagination" class="pagination">
		    ...
		    <a id="urlnext" href="communityissuespag"/></a>
    ...
    <div class="span4 pull-right">
      <div class="well">
      <h2> Add a community issue</h2>
      <hr>
     <form method="post" action="addIssue" enctype="multipart/form-data">
  ...
  <fieldset>
    ...
    <input class="span10" type="text" placeholder="Issue Title" id="title" name="title">
    <label>Select a date you this it started</label>
    <div class="input-append date" id="dp3" data-date="" data-date-format="mm-dd-yyyy">
	    <input class="span2" size="16" type="text" value="" id="date" name="date" placeholder="MM-dd-yyyy">
	    <span class="add-on"><i class="icon-calendar"></i></span>
    </div>
    <label>Issue Location</label>
    <input class="span10" type="text" placeholder="Location" id="location" name="location">
    <label>describe the issue</label>
<textarea class="span10" rows="3" id="descrip" name="descrip"></textarea>
<p>
                Enter tag's to easily find your deal <br>ex:Kids Party, garage Sale
      ...
      <input type="checkbox"> I agree to <a href="#">Terms &amp; Condition</a><br>
       <input type="checkbox"> Post as anonymous
    </label>
 <button type="submit" class="btn">Submit</button>
  ...
  <h2>Issues Created by you</h2>
    	...
    	<c:forEach items="${myList.list}" var="row">
	        <div class="thumb">
	          <div class="pic">
				<img src="${photosFolder}${row.id}-thumb.jpg" alt="" onError="this.src='resources/img/marco.gif';">
	          </div>
	          <div class="username"><a href="#"> ${row.title}</a> </div>
	          <div class="status">${row.date_f} </div>
	          <div class="status">${row.location}</div>
        ...
        <a class="btn-mini pull-left" href="editrecommendations">Edit Recommendations  </a><a class="btn-mini pull-right">View More </a> </div>
...
$(document).ready(function(){
	...
	var checkout = $('#dp3').datepicker().on('changeDate', function(ev) {
		checkout.hide();
    }).data('datepicker');
