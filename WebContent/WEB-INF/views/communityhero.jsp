...
<div class="container-fluid max-1200"> 
  ...
  <div class="row-fluid">
    ...
    <h2>Based on your interest in miami area we found:</h2>
      ...
      <!-- /dynamic-info -->   
      <h2>We  found 10 Community Heros near your area:</h2>
      <hr>
      <p>Found total of 10 Community Heros within 2 mile radius. Use the slider to modify the distance.</p>
	...
	<div id="pagination" class="pagination">
	    ...
	    <a id="urlnext" href="communityheropag"/></a>
    ...
    <div class="span4 pull-right">
      <div class="well">
      <h2>Recommend a Community Hero</h2>
      <hr>
     <form method="post" action="addCommunityhero" enctype="multipart/form-data">

  <fieldset>
    <label>Person Name</label>
    <input class="span10" type="text" placeholder="Community hero name" id="title" name="title">
...
<p>
                Enter tag's to easily find the business <br>ex:tag1, Tag2
 ...
 <button type="submit" class="btn">Submit</button>
  ...
  <h2>Community Heros recommended by you</h2>
           <hr>
         <div class="thumb-list">
          ...
          <a class="btn-mini pull-left" href="editrecommendations">Edit Recommendations  </a>
