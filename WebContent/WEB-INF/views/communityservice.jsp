...
<div class="container-fluid max-1200"> 
  ...
  <div class="row-fluid">
    ...
    <h2>Based on your interest in miami area we found:</h2>
      ...
      <!-- /dynamic-info -->    
      <h2>We  found 10 Community Service near your area:</h2>
      <hr>
	...
	<div id="pagination" class="pagination">
	    ...
	    <a id="urlnext" href="communityservicepag"/></a>
    ...
    <div class="span4 pull-right">
      <div class="well">
      <h2>Recommend a Community Service</h2>
      <hr>
     <form method="post" action="addCommunityservice" enctype="multipart/form-data">
  ...
  <fieldset>
    ...
    <textarea rows="3" class="span10" id="descrip" name="descrip"></textarea>
    <p>
 ...
 <button type="submit" class="btn">Submit</button>
  ...
  <h2>Community Service recommended by you</h2>
           <hr>
         <div class="thumb-list">
