...
<head>
<meta charset="utf-8">
<title>Zoowaa Events &amp; updates</title>
...
<div class="container-fluid max-1200"> 
  ...
  <div class="row-fluid">
    ...
    <h2>Based on your interest in miami area we found:</h2>
      ...
      <!-- /dynamic-info -->      
      <h2>We  found the below events near your area:</h2>
      <hr>
      <p>Found total of 24 events within 2 mile radius. Use the slider to modify the distance.</p>
